...
HD_PWD='E:/Digital_Logic/Labs/Lab5/Lab5_BCD_to_Grey_expression/BCD_to_Grey_expression/BCD_to_Grey_expression.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_to_grey_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcd_to_grey_top.tcl -notrace
