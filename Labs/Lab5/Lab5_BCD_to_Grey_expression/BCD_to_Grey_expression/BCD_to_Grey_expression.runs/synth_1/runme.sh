...
HD_PWD='E:/Digital_Logic/Labs/Lab5/Lab5_BCD_to_Grey_expression/BCD_to_Grey_expression/BCD_to_Grey_expression.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_to_grey_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd_to_grey_top.tcl
