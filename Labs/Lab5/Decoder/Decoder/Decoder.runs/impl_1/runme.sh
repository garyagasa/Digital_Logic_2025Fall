...
HD_PWD='E:/Digital_Logic/Labs/Lab5/Decoder/Decoder/Decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Decoder24_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Decoder24_Top.tcl -notrace
