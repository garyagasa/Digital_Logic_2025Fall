...
HD_PWD='E:/Digital_Logic/Labs/Lab5/Decoder/Decoder/Decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Decoder24_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Decoder24_Top.tcl
