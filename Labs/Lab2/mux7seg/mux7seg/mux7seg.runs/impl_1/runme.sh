...
HD_PWD='E:/Digital_Logic/Labs/Lab2/mux7seg/mux7seg/mux7seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux7seg.tcl -notrace
