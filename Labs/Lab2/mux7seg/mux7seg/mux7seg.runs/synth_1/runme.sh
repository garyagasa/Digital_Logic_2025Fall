...
HD_PWD='E:/Digital_Logic/Labs/Lab2/mux7seg/mux7seg/mux7seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux7seg.tcl
