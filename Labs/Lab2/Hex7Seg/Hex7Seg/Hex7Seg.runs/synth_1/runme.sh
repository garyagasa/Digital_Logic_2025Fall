...
HD_PWD='E:/Digital_Logic/Labs/Lab2/Hex7Seg/Hex7Seg/Hex7Seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Hex7Seg_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Hex7Seg_Top.tcl
