...
HD_PWD='E:/Digital_Logic/Labs/Lab2/Hex7Seg/Hex7Seg/Hex7Seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Hex7Seg_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Hex7Seg_Top.tcl -notrace
